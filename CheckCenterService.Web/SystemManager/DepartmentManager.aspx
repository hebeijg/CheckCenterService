<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DepartmentManager.aspx.cs" Inherits="CheckCenterService.Web.SystemManager.DepartmentManager" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            document.getElementById("iframe").src="DepartmentList.aspx?token="+t+"&t="+Math.random();
        });
        ...
        function zTreeOnClick(event, treeId, treeNode) {
            ...
            document.getElementById("iframe").src="DepartmentList.aspx?token="+t+"&department="+encodeURI(dept)+"&t="+Math.random();
        };
