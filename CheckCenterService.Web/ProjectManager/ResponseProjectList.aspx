<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ResponseProjectList.aspx.cs" Inherits="CheckCenterService.Web.ProjectManager.ResponseProjectList" %>
                                ...
                                <asp:Panel ID="panelgvAuthor" runat="server" CssClass="PanelBackColor" ScrollBars="Horizontal">
                                    <asp:GridView ID="gvDepartmentList" runat="server" DataKeyNames="ProjectId" AutoGenerateColumns="false"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="BusinessManagerName" HeaderText="业务主任" ItemStyle-Width="180px" />
