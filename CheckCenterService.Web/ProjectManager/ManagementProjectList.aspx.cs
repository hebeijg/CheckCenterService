...
{
    public partial class ManagementProjectList : PageBase
    {
        ...
        {
            string searchConditon = " and p.CreatedUserId="+LoginUser.UserId;
        ...
        protected void lbtnEdit_Click(object sender, EventArgs e)
        {
            ...
            Response.Redirect("ProjectEdit.aspx?ProjectId="+projectId);
